 ...
 */
final class Version20200109115507 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, phone_number VARCHAR(255) NOT NULL, token VARCHAR(255) NOT NULL, secret VARCHAR(255) NOT NULL, pin VARCHAR(255) NOT NULL, registered_at DATETIME NOT NULL, authenticated_at DATETIME NOT NULL, mya2billing_code VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, new_phone_number VARCHAR(255) NOT NULL, carrier_id INT NOT NULL, notified_at DATETIME NOT NULL, balance_notifications SMALLINT NOT NULL, prev_pin VARCHAR(255) NOT NULL, last_park_request_at DATETIME NOT NULL, selected_did_id VARCHAR(255) NOT NULL, promotion_expires_at DATETIME NOT NULL, promotion_status SMALLINT NOT NULL, admin TINYINT(1) NOT NULL, r2r TINYINT(1) NOT NULL, f2g TINYINT(1) NOT NULL, use_sip TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
